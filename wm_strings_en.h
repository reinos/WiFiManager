...
const char HTTP_SAVED[]            PROGMEM = "<div class='msg'>Saving Credentials and trying to connect to the selected network.<br />If it fails, you can reconnect to AP to try again</div>";
